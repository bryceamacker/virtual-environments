...
# Change waagent entries to use /mnt for swapfile if not building docker image
...
sed -i 's/::1 ip6-localhost ip6-loopback/::1     localhost ip6-localhost ip6-loopback/g' ~/hosts.new
